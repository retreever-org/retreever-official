  ...
  return (
    ...
    >
      <div className="w-full">
        ...
        <div className="pointer-events-none absolute left-[14%] top-[34%] h-36 w-40 rounded-full bg-shadow-blue/18 blur-[58px] md:left-[7%] md:top-[-60%] md:h-100 md:w-120 md:bg-shadow-blue/18 md:blur-[120px]" />
