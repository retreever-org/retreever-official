const GetStartedSection = () => {
  ...
  return (
    <section className="relative overflow-hidden py-24 sm:py-28 lg:py-32">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-150 h-150 bg-blue-600/10 blur-[160px] rounded-full" />

      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
        {/* Heading */}
        <div className="text-center">
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-[5.5rem] font-black leading-none tracking-tight">
      ...
      <div className="flex flex-col items-center pt-15">
        <button className="group relative overflow-hidden rounded-[22px] bg-linear-to-r from-blue-500 to-blue-700 px-10 sm:px-12 py-4 sm:py-5 shadow-[0_0_50px_rgba(37,99,235,0.35)] transition-all duration-300 hover:scale-105">
